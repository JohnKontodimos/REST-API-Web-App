...
Κάντε clone το project με το terminal (σε όποιον φάκελο θέλετε)

```bash
  git clone https://github.com/JohnKontodimos/REST-API-Web-App
```
Στην συνέχεια μπορείτε χειροκίνητα να αντιγράψετε τους φακέλους **api.fuel.gr** και **fuel.gr** μέσα στον φάκελο htdocs (για XAMPP), ή στον φάκελο www (για WAMP).
